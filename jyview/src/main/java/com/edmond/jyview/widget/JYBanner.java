 ...
 */
public class JYBanner extends LinearLayout implements ViewPager.OnPageChangeListener{
    ...
    public JYBanner(Context context) {
        this(context,null);
    }

    public JYBanner(Context context, AttributeSet attrs) {
        super(context, attrs);
